...
// 以下是特殊的烟花形状
const crysanthemumShell = (size=1) => {//菊花状烟花
...
const crackleShell = (size=1) => {//有炸裂声音的烟花
	// favor gold
...
const horsetailShell = (size=1) => {//马尾烟花
	const color = randomColor();
	return {
		shellSize: size,
		horsetail: true,
...
function randomShellName() {//一半几率生成菊花状烟花，其余生成其他形状烟花
